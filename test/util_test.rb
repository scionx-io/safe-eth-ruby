...
class UtilTest < Minitest::Test
  ...
  def test_encode_meta_transaction
    ...
    actual_encoded_data = SafeEthRuby::Util.encode_transaction(@transactions.first)
    assert_equal(expected_encoded_data, actual_encoded_data)
  end

  def test_encode_multi_send_data
    expected_encoded_data = Eth::Util.hex_to_bin("")
    actual_encoded_data = SafeEthRuby::Util.encode_transactions(@transactions)
